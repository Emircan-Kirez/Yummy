...
import com.emircankirez.yummy.databinding.DialogSuccessBinding
...
class SuccessDialog constructor(
   context: Context
    ...
    private var binding: DialogSuccessBinding = DialogSuccessBinding.inflate(LayoutInflater.from(context))
